...
class TestTextNode(unittest.TestCase):
    def test_eq(self):
        ...
        node3 = TextNode("This is also a text node", TextType.LINKS, "www.google.com")
        node4 = TextNode("This is also a text node", TextType.LINKS, "www.google.com")
    ...
    def test_different_types(self):
        ...
        node10 = TextNode("Testing different texttypes", TextType.IMAGES)
